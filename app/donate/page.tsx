      ...
      <main className="container mx-auto mt-8 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mb-2 text-pink-800"><strong>Account Name:</strong> सीताराम सेवा संस्थान</p>
            <p className="mb-2 text-pink-800"><strong>Account Number:</strong> 123456789</p>
            <p className="mb-2 text-pink-800"><strong>IFSC Code:</strong> ABCD0123456</p>
            <p className="mb-2 text-pink-800"><strong>Bank Name:</strong> XYZ Bank</p>
            <p className="mb-2 text-pink-800"><strong>Branch:</strong> Main Branch, Indore</p>
          </div>
